...
/*  Created On : 25-nov.-2022 17:39:43 				*/
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Producto_Inventario]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
...
(
	...
	[No_documento] nvarchar(10) NOT NULL,
...
ALTER TABLE [Producto] ADD CONSTRAINT [FK_Producto_Inventario]
	FOREIGN KEY ([InventarioID]) REFERENCES [Inventario] ([InventarioID]) ON DELETE No Action ON UPDATE No Action
GO
